...
describe('System Integration Tests (e2e)', () => {
  ...
  describe('Authentication System Integration', () => {
    ...
    it('should handle user signup workflow', async () => {
      ...
      const response = await request(app.getHttpServer()).post('/auth/signup').send(signupData);
  ...
  describe('API Endpoint Integration', () => {
    ...
    beforeAll(async () => {
      ...
      const tokenResponse = await authService
        .signin('api-test@example.com', 'dummy-password')
        .catch(() => null);
