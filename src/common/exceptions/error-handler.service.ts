...
export class ErrorHandlerService {
  ...
  handleError(
    ...
    if (
      ...
      return this.handlePrismaUnknownError(
        error as Prisma.PrismaClientUnknownRequestError,
        requestId,
        userId,
      );
    }
    ...
    if (error.message.includes('config') || error.message.includes('environment')) {
      return new ConfigurationError(error.message || 'Configuration error', undefined, requestId);
    }
