...
export class EnhancedLoggerService {
  ...
  constructor(private readonly configService: ConfigService) {
    ...
    this.enableStructuredLogging = this.configService.get<boolean>(
      'ENABLE_STRUCTURED_LOGGING',
      true,
    );
    this.enablePerformanceLogging = this.configService.get<boolean>(
   ...
   */
  logAuthentication(event: string, success: boolean, method: string, context?: LogContext): void {
