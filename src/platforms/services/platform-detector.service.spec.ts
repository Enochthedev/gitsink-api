...
describe('PlatformDetectorService', () => {
    ...
    describe('generateRepositoryUrl', () => {
        it('should generate correct URLs for all platforms', () => {
            expect(service.generateRepositoryUrl('github', 'user', 'repo'))
                .toBe('https://github.com/user/repo');

            expect(service.generateRepositoryUrl('gitlab', 'user', 'repo'))
                .toBe('https://gitlab.com/user/repo');

            expect(service.generateRepositoryUrl('bitbucket', 'user', 'repo'))
