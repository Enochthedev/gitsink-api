...
export class BitbucketProvider extends BaseRepositoryProvider {
    ...
    async authenticate(credentials: PlatformCredentials): Promise<AuthResult> {
        try {
            const response = await this.makeAuthenticatedRequest<BitbucketUser>(
                credentials,
                {
                    method: 'GET',
    ...
    async fetchRepository(
        ...
        try {
            const response = await this.makeAuthenticatedRequest<BitbucketRepository>(
                credentials,
                {
                    method: 'GET',
    ...
    async fetchFileContent(
        ...
        try {
            ...
            const metaResponse = await this.makeAuthenticatedRequest<BitbucketFile>(
                credentials,
                {
                    method: 'GET',
            ...
            const contentResponse = await this.makeAuthenticatedRequest<string>(
                credentials,
                {
                    method: 'GET',
