...
export class GitHubProvider extends BaseRepositoryProvider {
  ...
  async authenticate(credentials: PlatformCredentials): Promise<AuthResult> {
    try {
      const response = await this.makeAuthenticatedRequest<GitHubUser>(credentials, {
        method: 'GET',
  ...
  async fetchRepositories(
    ...
    try {
      ...
      const response = await this.makeAuthenticatedRequest<GitHubRepository[]>(credentials, {
        method: 'GET',
  ...
  async fetchFileContent(
    ...
    try {
      ...
      const response = await this.makeAuthenticatedRequest<GitHubContent>(credentials, {
        method: 'GET',
        url: `${url}${params}`,
      });
