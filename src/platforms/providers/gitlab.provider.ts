...
export class GitLabProvider extends BaseRepositoryProvider {
  ...
  async authenticate(credentials: PlatformCredentials): Promise<AuthResult> {
    try {
      const response = await this.makeAuthenticatedRequest<GitLabUser>(credentials, {
        method: 'GET',
  ...
  async fetchRepositories(
    ...
    try {
      ...
      const response = await this.makeAuthenticatedRequest<GitLabProject[]>(credentials, {
        method: 'GET',
  ...
  async fetchFileContent(
    ...
    try {
      ...
      const response = await this.makeAuthenticatedRequest<GitLabFile>(credentials, {
        method: 'GET',
