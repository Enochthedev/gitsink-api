        ...
        it('should fetch repository successfully', async () => {
            const mockRepo = {
                ...
                links: {
                    ...
                    avatar: { href: 'https://avatar.url' },
                    pullrequests: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/pullrequests' },
                    commits: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/commits' },
                    forks: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/forks' },
                    watchers: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/watchers' },
                    downloads: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/downloads' },
                    clone: [
                        {
                            name: 'https',
    ...
    describe('fetchFileContent', () => {
        it('should fetch file content successfully', async () => {
            const mockFile = {
                ...
                git_url: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/src/main/Portfolio.md',
                type: 'commit_file',
                commit: {
                    hash: 'abc123',
                    type: 'commit',
                    links: {
                        self: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/commit/abc123' },
                        html: { href: 'https://bitbucket.org/testuser/test-repo/commits/abc123' },
                    },
                },
                attributes: [],
                links: {
                    self: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/src/main/Portfolio.md' },
                    meta: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/src/main/Portfolio.md?format=meta' },
                    history: { href: 'https://api.bitbucket.org/2.0/repositories/testuser/test-repo/filehistory/main/Portfolio.md' },
                },
            };
