...
export class BitbucketWebhookController {
    ...
    private async handlePushEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket push event for repository: ${payload.repository.full_name}`);
    ...
    private async handleForkEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket fork event for repository: ${payload.repository.full_name}`);
        // TODO: Update fork count if needed
    }

    private async handleCommitCommentEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket commit comment event for repository: ${payload.repository.full_name}`);
        // TODO: Handle commit comments if needed
    }

    private async handleCommitStatusEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket commit status event for repository: ${payload.repository.full_name}`);
    ...
    private async handleIssueEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket issue event for repository: ${payload.repository.full_name}`);
    ...
    private async handleIssueCommentEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket issue comment event for repository: ${payload.repository.full_name}`);
        // TODO: Handle issue comments if needed
    }

    private async handlePullRequestEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket pull request event for repository: ${payload.repository.full_name}`);
    ...
    private async handlePullRequestCommentEvent(payload: BitbucketWebhookPayload): Promise<void> {
        this.logger.debug(`Processing Bitbucket pull request comment event for repository: ${payload.repository.full_name}`);
