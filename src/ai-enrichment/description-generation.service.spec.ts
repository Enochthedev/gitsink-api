...
describe('DescriptionGenerationService', () => {
  ...
  const mockRepositoryContent: RepositoryContent = {
    ...
    readme:
      'This is a REST API built with Express.js for handling user authentication and data management.',
    packageJson: {
      name: 'test-api',
      dependencies: { express: '^4.18.0' },
    },
  ...
  describe('generateDescription', () => {
    it('should generate description using AI service when configured', async () => {
      const mockAIResponse = {
        data: {
          description:
            'A Node.js REST API built with Express.js for user management and authentication.',
          confidence: 0.9,
        },
        status: 200,
        statusText: 'OK',
    ...
    it('should use fallback when AI service is not configured', async () => {
      ...
      const serviceWithoutAI = module.get<DescriptionGenerationService>(
        DescriptionGenerationService,
      );
