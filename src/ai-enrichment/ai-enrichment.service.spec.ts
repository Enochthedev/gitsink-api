...
describe('AIEnrichmentService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: TechnologyDetectionService,
          useValue: mockTechnologyDetectionService,
        },
        {
          provide: DescriptionGenerationService,
          useValue: mockDescriptionGenerationService,
        },
        {
          provide: ProjectCategorizationService,
          useValue: mockProjectCategorizationService,
        },
  ...
  describe('analyzeRepository', () => {
    ...
    it('should handle analysis service failures gracefully', async () => {
      technologyDetection.detectTechnologies.mockRejectedValue(
        new Error('Technology detection failed'),
      );
      descriptionGeneration.generateDescription.mockRejectedValue(
