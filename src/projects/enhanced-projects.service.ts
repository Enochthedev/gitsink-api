...
export class EnhancedProjectsService {
     ...
     */
    private async syncRepositoriesForPlatform(
        userId: string,
    ...
    private async checkRepositoryBlacklist(
        ...
        try {
            ...
            if (profileResponse.data) {
                const content = profileResponse.data.encoding === 'base64'
    ...
    private async getPlatformCredentials(
        ...
        const refreshToken = connection.refreshToken && encryptionKey
