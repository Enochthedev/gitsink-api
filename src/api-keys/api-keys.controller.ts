...
export class ApiKeysController {
    ...
    @Get()
    @ApiOperation({ summary: 'List all API keys', description: 'Get all API keys for the authenticated user' })
    ...
    @Get('stats')
    @ApiOperation({ summary: 'Get API key statistics', description: 'Get usage stats and limits for API keys' })
    ...
    @Get(':id')
    @ApiOperation({ summary: 'Get API key details', description: 'Get details for a specific API key' })
